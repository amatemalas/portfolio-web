<footer class="py-4 bg-secondary text-info">
        ...
        <div class="row">
                ...
                <div class="d-flex flex-column justify-content-between h-100">
                    <div>
                        ...
                        <div class="d-flex py-3">
                            <a href="https://github.com/amatemalas" target="_blank" class="text-light me-3"><i class="fa-brands fa-github fa-xl"></i></a>
                            <a href="https://www.linkedin.com/in/adri%C3%A1n-matemalas-manzanaro-46a4831a0/" target="_blank" class="text-light me-3"><i class="fa-brands fa-linkedin fa-xl"></i></a>
                            <a href="https://www.instagram.com/holy_ghost____/" target="_blank" class="text-light me-3"><i class="fa-brands fa-instagram fa-xl"></i></a>
            ...
            <div class="col-12 col-md-3 py-md-0 py-4">
                ...
                <div class="d-flex align-items-center flex-wrap">
                    ...
                    <span class="badge rounded-pill bg-primary me-1 mb-2 fw-normal">OctoberCMS</span>
                    <span class="badge rounded-pill bg-primary me-1 mb-2 fw-normal">Wordpress</span>
                    ...
                    <span class="badge rounded-pill bg-primary me-1 mb-2 fw-normal">Adobe Photoshop</span>
